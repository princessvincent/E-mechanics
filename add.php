...
if(isset($_POST["conti"]) && isset($_POST["add"])){
    $add = $_POST["add"];
    ...
    // if($state == $sta){
        ...
        $selet  = "SELECT * FROM register WHERE shop_address = '$add'";
...
<body>
 <div>
   ...
   Your Address:<input type="text" name="add" placeholder="The Address you are Currently In.">
